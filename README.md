...
2.📥 Download Links
Model Checkpoints Download Link: 👉 Click [here](https://drive.google.com/drive/folders/1w6NUxo5z_A_HVzhu8xSft7bcniHzgAw2?dmr=1&ec=wgc-drive-%5Bmodule%5D-goto) to download UniMedSeg Checkpoints (Please replace this with your actual download URL)
...
│   │   └── [Place the downloaded UniMedSeg model checkpoints (e.g., .ckpt or .pt) here]
